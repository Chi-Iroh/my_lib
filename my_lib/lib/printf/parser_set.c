...
{
    FREE_IF_ALLOCATED(flag->flag_str, free);
    FREE_IF_ALLOCATED(flag->flag_struct->length_modifier, free);
    FREE_IF_ALLOCATED(flag->flag_struct, free);
    FREE_IF_ALLOCATED(flag, free);
}
...
size_t set_field_width(const wchar_t *format, flag_t *flag, va_list args)
{
    size_t count = 0;
...
size_t set_precision(const wchar_t *format, flag_t *flag, va_list args)
{
    size_t count = 1;
...
size_t set_length_modifier(const wchar_t *format, flag_t *flag)
{
